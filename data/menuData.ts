  ...
  "Ala Carte & Grill": [
    {
      ...
      price: 79,
      description:
        "Crispylicious, juicylicious Chickenjoy paired with the tastiest and meatiest spaghetti, topped with rich, savory sauce and loaded with flavor in every bite. A perfect combo that brings ultimate sarap and satisfaction to every meal.",
      isBestSeller: true,
