        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-6 leading-relaxed">
              Bawat Kagat, May Kwento. Authentic Filipino grilling experience
              that brings families and friends together.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin
                  size={18}
                  className="text-[#e13e00] flex-shrink-0 mt-0.5"
                />
              ...
              <li className="flex items-center gap-3">
                <Phone size={18} className="text-[#e13e00] flex-shrink-0" />
                <a
              ...
              <li className="flex items-center gap-3">
                <Mail size={18} className="text-[#e13e00] flex-shrink-0" />
                <a
              ...
              <li className="flex items-center gap-3">
                <Clock size={18} className="text-[#e13e00] flex-shrink-0" />
                <span className="text-gray-400 text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-400 text-sm">Get exclusive deals and updates straight to your inbox!</p>
            </div>
            <form 
              onSubmit={(e) => {
                e.preventDefault();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
            <p className="text-gray-400 text-sm">
              © {currentYear} Harrison – House of Inasal & BBQ. All rights reserved.
            </p>
